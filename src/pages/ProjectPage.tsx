...
const ProjectsPage: React.FC<ProjectProps> = ({theme}) => {
  const projects = [
    ...
    { title: 'WeatherWise', description:'A full-stack application built using React.js, FastApi, and Zustand for state management. This was one of the first colaborative projects I worked on and get first hand experience working with git. I primarily focused on designing the backend, but also worked frequently to assist in front-end troubleshooting.',image:'Sample', link:'Sample'},
    { title: 'PieCart', description:'A full stack application designed and built collaborativly with a team for a software engineering class. The backend was fully designed and deployed within AWS utilizing tooling such as Lambda, API Gateway, and Cognito for User Authentication and session management',image:'Sample', link:'Sample'},
    { title: 'Housing Data Statistics Project', description:'A project made ',image:'Sample', link:'Sample'},
