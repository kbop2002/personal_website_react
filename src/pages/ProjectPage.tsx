...
const ProjectsPage: React.FC<ProjectProps> = ({theme}) => {
  const projects = [
    ...
    { title: 'WeatherWise', description:'A full-stack application built using React.js, FastApi, and Zustand for state management. This was one of the first colaborative projects I worked on and get first hand experience working with git. I primarily focused on designing the backend, but also worked frequently to assist in front-end troubleshooting.',image:'/under.jpg', link:'Sample'},
